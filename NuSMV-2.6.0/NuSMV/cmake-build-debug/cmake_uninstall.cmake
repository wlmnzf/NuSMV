...
foreach(file ${files})
  ...
  if(IS_SYMLINK "$ENV{DESTDIR}${file}" OR EXISTS "$ENV{DESTDIR}${file}")
    execute_process(
      COMMAND /home/william/Downloads/clion-2018.3.4/bin/cmake/linux/bin/cmake -E remove "$ENV{DESTDIR}${file}"
...
foreach(d ${alldirs})
  ...
  if(NOT l AND IS_DIRECTORY "${d}")
      ...
      execute_process(
        COMMAND /home/william/Downloads/clion-2018.3.4/bin/cmake/linux/bin/cmake -E remove_directory "${d}"
        OUTPUT_VARIABLE rm_out
        RESULT_VARIABLE rm_retval
      )
      if(NOT ${rm_retval} EQUAL 0)
